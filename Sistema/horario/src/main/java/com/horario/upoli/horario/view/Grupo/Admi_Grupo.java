...
public class Admi_Grupo  extends Editor{
    ...
    public String Enviar_Formulario() {
        ...
        cuerpo_f.add(" <div class=\"input-field col s6\">\n" +
                ...
                "                            <label for=\"buscar\">Filtrar Grupo</label>\n" +
                "                        </div>\n" +
    ...
    private ArrayList<String> Generar_cuerpo()
    {
        ...
        for (Grupo n:Aux
            ...
            Resultado.add("<tr>\n" +
                    ...
                    "                                <td>\n" +
                    "                                    <a class=\"btn-floating  waves-effect waves-light \" href=\""+Edit+"/"+n.getId_grupo()+"\">\n" +
                    "                                        <i class=\"material-icons\">mode_edit</i>\n" +
                    "                                    </a>\n" +
                    "                                    <a class=\"btn-floating  waves-effect waves-light red\" href=\""+Delete+"/"+n.getId_grupo()+"\">\n" +
    ...
    public  String Generar_Admi_Grupo(){
        html.setTitulo("SDH");
