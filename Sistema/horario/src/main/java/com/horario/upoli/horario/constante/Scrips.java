...
public enum Scrips {
    ...
    app("<script src=\"https://firebasestorage.googleapis.com/v0/b/horario-8c987.appspot.com/o/js%2Fapp.js?alt=media&token=a19f8694-0df0-498a-97ae-4aec7a29e8ce\"></script>");
