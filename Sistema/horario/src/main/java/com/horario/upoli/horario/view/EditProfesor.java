...
public class EditProfesor {
    private Html html = new Html();
    private Usuario usuario = new Usuario();
    private Profesor profesor= new Profesor();
    private boolean nuevo=false;

    public EditProfesor(Profesor profesor, boolean nuevo) {
     ...
     private String Enviar_Formulario(){
        ...
        //////////////////////////
         ...
         cuerpo.add("<div class=\"card-content \">\n" +
                 ...
                 "                                <input id=\"txt_nombre\" type=\"text\"  data-length=\"50\"  value=\""+profesor.getNombre()+"\" name=\"txt_nombre\" class=\"validate\">\n" +
                 "                                <label for=\"txt_nombre\">Nombre:</label>\n" +
                 "                            </div>\n" +
                 "                            <div class=\"input-field \">\n" +
                 "                                <input id=\"txt_apellido\" type=\"text\" data-length=\"50\" value=\""+profesor.getApellido()+"\" name=\"txt_apellido\" class=\"validate\">\n" +
